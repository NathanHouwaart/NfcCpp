/**
 * @file main.cpp
 * @brief DESFire CreateBackupDataFile example
 *
 * Flow:
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        std::cout << "DESFire CreateBackupDataFile Example\n";
        ...
        auto createResult = desfire->createBackupDataFile(
            args.fileNo,
        ...
        if (!createResult)
        {
            ...
            {
                std::cout << "CreateBackupDataFile returned DuplicateError; continuing (--allow-existing)\n";
                return 0;
            }

            std::cerr << "CreateBackupDataFile failed: " << createResult.error().toString().c_str() << "\n";
            return 1;
        }

        std::cout << "CreateBackupDataFile OK\n";
        return 0;
    }
