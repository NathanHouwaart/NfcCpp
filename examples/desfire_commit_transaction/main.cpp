/**
 * @file main.cpp
 * @brief DESFire CommitTransaction example
 *
 * Flow:
...
namespace
{
    ...
    void printUsage(const char* exeName)
    {
        ...
        std::cout << "  --authenticate                            Authenticate before commit\n";
        ...
        std::cout << "  --allow-no-changes                        Treat 0x0C (NoChanges) as success\n";
    }
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        std::cout << "DESFire CommitTransaction Example\n";
