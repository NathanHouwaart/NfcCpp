# DESFire CreateStdDataFile Command Guide

## Purpose

`CreateStdDataFile` creates a standard data file in the currently selected application.
...
`CreateStdDataFile` uses a 7-byte payload:
...
- Command header: `Include/Nfc/Desfire/Commands/CreateStdDataFileCommand.h`
- Command source: `Src/Nfc/Desfire/Commands/CreateStdDataFileCommand.cpp`
- Card helper method: `DesfireCard::createStdDataFile(...)` in
...
`examples/desfire_create_std_data_file/main.cpp`
