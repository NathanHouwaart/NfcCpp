/**
 * @file ClearRecordFileCommand.h
 * @author Nathan Houwaart (n.m.houwaart@hva.nl)
 * @brief DESFire clear record file command
 * @version 0.1
 * @date 2026-02-16
 *
...
{
    /**
     * @brief Clear record file command
     *
     * Clears a linear/cyclic record file in the currently selected
     * application (INS 0xEB) using payload FileNo(1).
     *
     * Note: This operation is transactional on DESFire and typically requires
     * CommitTransaction to persist.
     */
    class ClearRecordFileCommand : public IDesfireCommand
    {
    public:
        /**
         * @brief Construct clear record file command
         *
         * @param fileNo File number (0..31)
         */
        explicit ClearRecordFileCommand(uint8_t fileNo);
