/**
 * @file FormatPiccCommand.h
 * @author Nathan Houwaart (n.m.houwaart@hva.nl)
 * @brief DESFire format PICC command
 * @version 0.1
 * @date 2026-02-16
 *
...
{
    /**
     * @brief Format PICC command
     *
     * Executes DESFire FormatPICC (INS 0xFC).
     *
     * This is a destructive PICC-level operation that removes all
     * applications and files on the card.
     */
    class FormatPiccCommand : public IDesfireCommand
    {
    public:
        /**
         * @brief Construct format PICC command
         */
        FormatPiccCommand();
