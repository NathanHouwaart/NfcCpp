/**
 * @file LimitedCreditCommand.h
 * @author Nathan Houwaart (n.m.houwaart@hva.nl)
 * @brief DESFire limited credit command
 * @version 0.1
 * @date 2026-02-15
 *
...
{
    /**
     * @brief Limited credit command options
     */
    struct LimitedCreditCommandOptions
    {
        uint8_t fileNo;
        int32_t value;
    ...
    /**
     * @brief LimitedCredit command
     *
     * Executes DESFire LimitedCredit (INS 0x1C).
     */
    class LimitedCreditCommand : public IDesfireCommand
    {
    public:
        /**
         * @brief Construct limited credit command
         *
         * @param options Command options
         */
        explicit LimitedCreditCommand(const LimitedCreditCommandOptions& options);
