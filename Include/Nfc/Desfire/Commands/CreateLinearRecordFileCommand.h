/**
 * @file CreateLinearRecordFileCommand.h
 * @author Nathan Houwaart (n.m.houwaart@hva.nl)
 * @brief DESFire create linear record file command
 * @version 0.1
 * @date 2026-02-16
 *
...
{
    /**
     * @brief Create linear record file command options
     *
     * Payload layout (INS 0xC1):
     * - FileNo (1 byte)
     ...
     */
    struct CreateLinearRecordFileCommandOptions
    {
        uint8_t fileNo;
    ...
    /**
     * @brief Create linear record file command
     *
     * Creates a DESFire linear record file (INS 0xC1).
     */
    class CreateLinearRecordFileCommand : public IDesfireCommand
    {
    public:
        /**
         * @brief Construct create linear record file command
         *
         * @param options Command options
         */
        explicit CreateLinearRecordFileCommand(const CreateLinearRecordFileCommandOptions& options);
